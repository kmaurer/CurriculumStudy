\documentclass[smallextended, natbib]{tise_style_supplemental} 
...
\author{Karsten Maurer \hspace{1in} Miami University \\
        Dennis Lock \hspace{1in} Iowa State University}
...
%appendix-------------------------------------------------------
\section{Final Exam Used in Curricula Study}
\label{appendA}
